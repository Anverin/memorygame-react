...
//         this.setState({
//             cards: this.prepareCards(), clicks: 0, isPopupOpened: false, isBestScore: false  //обновить state, исходя из новых данных
//         });
//     }
//
//     prepareCards() {
...
//                         {this.state.isBestScore &&  <div className="game-complete">Игра завершена! <br/> Вы показали лучший результат! Ваш результат: {this.state.clicks} кликов!</div>}
//                         {/*после первой игры не покажется (в lastBestScore ничего) */}
//                         {this.state.isBestScore && localStorage.getItem('lastBestScore') &&  <div className="best-score">Прежний лучший результат: {localStorage.getItem('lastBestScore')} кликов.</div>}
//
//                         {/*если не лучший*/}
//                         {!this.state.isBestScore && <div className="game-complete">Игра завершена! <br/> Ваш результат: {this.state.clicks} кликов!</div>}
//                         {!this.state.isBestScore && <div className="best-score">Лучший результат: {localStorage.getItem('bestScore')} кликов.</div>}
//
//                     </div>
//                 </Popup>
//             </div>
